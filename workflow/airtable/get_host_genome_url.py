...
parser.add_argument('--code', required=True, help='EHI genome ID')
...
#Set variables
url = 'https://api.airtable.com/v0/appQpr6MxnaiVHsHy/tbl7QOk2HKrZatIfG'
headers = {
...
output_file_path = 'host_genome_url.tsv'
...
if response.status_code == 200:
    ...
    if records:
        ...
        host_genome_value = record.get('fields', {}).get('Fasta link')
