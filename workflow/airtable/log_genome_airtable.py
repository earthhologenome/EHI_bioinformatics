### Automatically update AirTable from Mjolnir
...
parser.add_argument('--code', required=True, help='Genome ID')
...
#Set variables
url = 'https://api.airtable.com/v0/app6ADWyLxBkDcqYX/tbl1t5vnst50DjT9A'
headers = {
