...
desired_columns = ['EHI_plaintext', 'sample_code', 'species', 'region', 'sample_type', 'order', 'sex', 'country', 'latitude', 'longitude', 'singlem_fraction', 'reads_post_fastp', 'host_reads', 'reads_lost_fastp_percent', 'metagenomic_bases', 'host_bases', 'bases_lost_fastp_percent', 'diversity', 'C']
