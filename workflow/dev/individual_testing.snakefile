...
include: os.path.join(config["codedir"], "rules/vamb_individual.smk")
include: os.path.join(config["codedir"], "rules/semibin2_individual.smk")
include: os.path.join(config["codedir"], "rules/metawrap_refinement_testing.smk")
