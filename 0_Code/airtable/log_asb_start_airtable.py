### Automatically update AirTable from Mjolnir (with ASB completion status)
...
parser.add_argument('--code', required=True, help='ASB ID')
...
#Set variables
url = 'https://api.airtable.com/v0/appQpr6MxnaiVHsHy/tbld5JHhN4cM9P5ka'
headers = {
